        ...
        $(document).ready(function() {
            ...
            $('h1').click(function() {
                ...
                $(this).next('#k').slideDown('fast');
					...
					$("#divResult").html("</br><h2>AI CŨNG NÓI VẬY MÀ 😝😝😜😜</h2>");
					$("#divResult").fadeIn(2000,function()
							{
							$("#divResult2").fadeOut(0);
							$("#divResult2").html("<p>♥ Ừ THÌ ANH BIẾT ANH ĐẸP TRAI THẬT. NHƯNG ĐÂU CẦN EM THẬT THÀ VẬY ĐÂU .♥️♥️♥️♥️♥️</p></br>");
							$("#divResult2").fadeIn(2000,function()
									{
									$("#divResult3").fadeOut(0);
									$("#divResult3").html("<p>VẬY HÃY ĐỂ ANH ÔM EM 1 CÁI NHÉ 😍😍😍  </p></br>");
